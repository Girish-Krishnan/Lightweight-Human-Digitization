...
objpoints_1 = [] # for D415 
objpoints_2 = [] # for D435
objpoints_3d = []
...
images_1 = glob.glob('./calibration_images/D415/*.jpg')  # images from D415
images_2 = glob.glob('./calibration_images/D435/*.jpg')  # images from D435
