...
images_1 = glob.glob('./calibration_images/D415/*' + IMAGE_TYPE)  # images from D415
images_2 = glob.glob('./calibration_images/D435/*' + IMAGE_TYPE)  # images from D435
...
rms, K1, D1, K2, D2, R, T, E, F = cv2.stereoCalibrate(objpoints,imgpoints_1,imgpoints_2,mtx_1,dist_1,mtx_2,dist_2,gray_1.shape[::-1],criteria)
