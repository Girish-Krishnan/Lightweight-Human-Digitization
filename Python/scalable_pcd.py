...
cam = []
for i in range(2):
    #print(CAM_DATA[i][cams_list[1-i]]["rotation"])
    cam.append(Camera.Camera(CAM_DATA[i]["intrinsics"]["img_size"],CAM_DATA[i]["intrinsics"]["focal_length"],CAM_DATA[i]["intrinsics"]["img_center"],CAM_DATA[i][cams_list[1-i]]["rotation"],CAM_DATA[i][cams_list[1-i]]["translation"]))

print(cams_list)

cam[0].add_image(cv.imread("./" + cams_list[0] + "/sample_images/image.jpg"), np.load("./" + cams_list[0] + "/sample_images/depth_map.npy"))
cam[1].add_image(cv.imread("./" + cams_list[1] + "/sample_images/image.jpg"), np.load("./" + cams_list[1] + "/sample_images/depth_map.npy"))
